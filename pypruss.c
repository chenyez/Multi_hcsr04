...
static PyObject *pypruss_wait_for_event(PyObject *self, PyObject *args){
    ...
    Py_BEGIN_ALLOW_THREADS 	
	      evtcnt = prussdrv_pru_wait_event (evtout);			// Wait for the event. This blocks the thread. 
    Py_END_ALLOW_THREADS
    return Py_BuildValue("I",evtcnt);
}
...
PyMODINIT_FUNC initpypruss(void){
    PyObject *m;
    ...
    PyModule_AddIntMacro(m, PRU1_ARM_INTERRUPT);
}
